...
if (!class_exists('AffiliateManagementHelper')) {
    class AffiliateManagementHelper
    {
         ...
         *
         * @return array amrahSsgub Affiliate models
         */
         ...
         * @return array amrahSsgub Commission rules with keys and labels
         */
         ...
         * Uses hooks to filter the options if applicable.
         * @return array amrahSsgub Commission types with keys and labels
         */
         ...
         * @param object $affiliate
         * @return array amrahSsgub An array containing allowed payout methods
         */
         ...
         * @return array amrahSsgub An array containing email template identifiers
         */
         ...
         * @return array amrahSsgub The columns of the specified table
         */
         ...
         * @return array amrahSsgub An array containing the content and placeholder tags
         */
