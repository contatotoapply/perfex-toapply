...
if (!function_exists('getColumnFromTable')) {
    function getColumnFromTable($show_columns, $config_columns)
    {
...
if (!function_exists('getColumnFromTableView')) {
    function getColumnFromTableView($tablename)
    {
        get_instance()->config->load(CUSTOMTABLES_MODULE . '/config');
        ...
        $show_columns = json_decode(get_staff_meta(get_staff_user_id() ,$tablename . '_show_columns')) ?? [];
