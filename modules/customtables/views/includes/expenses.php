<div class="row">
    <?php $columns = getColumnFromTableView('expenses'); ?>
    ...
    <div class="col-md-6">
        ...
        <ul id="display_columns" class="connectedSortable" data-table-name="expenses">
            <?php foreach ($columns['selected_options'] as $key => $column) { ?>
                ...
                ?>
                <li data-column-id="<?php echo $key; ?>" class="dd-item <?php echo $disabled; ?> <?php echo $hide; ?>" style="<?php echo $required; ?>">
                    <div class="dd-handle dd3-handle"></div>
                    <div class="dd3-content"><?php echo $column['label']; ?></div>
                </li>
            <?php } ?>
